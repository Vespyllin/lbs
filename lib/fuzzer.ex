...
defmodule Fuzzer do
  ...
  defp insert_random_printable_ascii_character(str) do
    ascii = Enum.map(32..126, fn e -> <<e>> end)  # Printable ASCII (space to ~)
  ...
  def fuzz(item, n) do
    ...
    mutators = [&delete_random_character/1, &insert_random_printable_ascii_character/1, &flip_random_bit/1]
